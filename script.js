...
const contextualTips = {
    ...
    'Créer des exemples ou études de cas': { title: "Vigilance : Authenticité", content: "Les exemples générés à l’aide d’une IAg peuvent être trop génériques. Adaptez-les pour qu'ils soient authentiques et pertinents pour le champ disciplinaire et le vécu de vos étudiantes et étudiants." },
    'Concevoir des activités d\'apprentissage': { title: "Bonne pratique : Alignement pédagogique", content: " Assurez-vous que chaque activité proposée par l’IAG que vous décidez de mettre en œuvre soit pertinente pour votre contexte et directement liée à un objectif d’apprentissage précis de votre cours." },
    'Rédiger des notes de cours ou synthèses': { title: "Vigilance : Exactitude et profondeur", content: "Validez chaque information. L'IAg peut résumer, mais c'est votre expertise qui ajoute la profondeur et la perspective critique nécessaires." },
    'Créer des diapositives de présentation': { title: "Bonne pratique : Support visuel, pas script", content: "Utilisez l’IAG pour structurer vos idées et suggérer des visuels. Chaque diapositive doit rester concise et servir de support à votre discours, et non le remplacer." },
    'Générer du contenu pour supports visuels': { title: "Vigilance : Pertinence et clarté", content: " Un bon visuel (schéma, infographie) simplifie une idée complexe. Les logiciels d’IA pour créer des présentations peuvent être très pratiques, mais ils peuvent parfois surcharger les diapositives ou produire des images peu pertinentes. Veillez à ce que le résultat soit clair, non encombré et qu’il reflète fidèlement votre message." },
    'Rédiger des questions d\'examen': { title: "Vigilance : Validité et équité", content: "Assurez-vous que les questions générées évaluent le concept ou la compétence appropriés et qu’elles sont exemptes d’imprécisions ou d’erreurs." },
    'Élaborer des grilles d\'évaluation': { title: "Bonne pratique : Clarté des critères", content: "Une grille générée par l'IAg est un bon point de départ. Affinez les descripteurs de chaque critère pour qu'ils soient clairs, observables et sans ambiguïté pour vous et vos personnes étudiantes." },
    'Rédiger des annonces ou courriels': { title: "Vigilance : Ton et personnalisation", content: "Ajustez toujours le ton du message pour qu'il corresponde à votre style de communication habituel. Certains outils d’IAg peuvent proposer des formulations trop formelles ou impersonnelles." },
    ...
    'Générer des explications alternatives pour des concepts difficiles': { title: "Bonne pratique : Flexibilité cognitive", content: "L'IAg peut proposer des analogies ou des métaphores variées pour un même concept. C'est un bon moyen d'aider les personnes étudiantes ayant différentes manières d’apprendre." },
    'Synthétiser des articles pour le développement professionnel': { title: "Vigilance : Perte de nuance", content: "Un résumé effectué à l’aide d'un outil d’IAg est un point de départ. Toutefois, il demeure indispensable de lire et d’analyser attentivement le texte original afin de bien comprendre le sujet." },
    
    // GAIDET / Researcher
    'Génération d\'idées': { title: "Bonne pratique", content: "Utilisez l'IAg pour la divergence (générer beaucoup d'idées), mais gardez le contrôle de la convergence (choisir, critiquer et affiner les meilleures)." },
    'Définition de l\'objectif de recherche': { title: "Vigilance", content: "L'IAg peut aider à clarifier un objectif, mais celui-ci doit découler de votre compréhension profonde du domaine et d'une lacune réelle dans les connaissances." },
    ...
    'Évaluation de la faisabilité et des risques': { title: "Vigilance", content: "L'IAg peut identifier des risques communs, mais ne peut évaluer les contraintes contextuelles (par exemple, accès aux données, budget, temps). Cette évaluation reste une responsabilité humaine." },
    'Test d\'hypothèse préliminaire': { title: "Bonne pratique", content: "L’IAg peut s’avérer très utile pour des simulations ou des modélisations basées sur des données existantes. Considérez ceci comme une exploration, pas une validation formelle." },
    'Recherche et systématisation de la littérature': { title: "Vigilance : Sources fantômes", content: "Validez chaque référence générée dans des bases de données académiques. L'IAg peut « halluciner » des sources qui n'existent pas." },
    'Rédaction de la revue de littérature': { title: "Vigilance : Plagiat et synthèse", content: "Le texte généré par un IAg est plutôt une compilation qu’une synthèse critique. Vous devez réécrire, analyser et intégrer les sources pour créer un argumentaire original." },
    'Analyse des tendances du marché et/ou de l\'environnement des brevets': { title: "Bonne pratique", content: "L'IAg excelle à analyser de grands volumes de données. Utilisez-la pour identifier des motifs, mais validez les conclusions avec votre expertise du domaine." },
    'Évaluation de la nouveauté de la recherche et identification des lacunes': { title: "Vigilance", content: " L’IAg peut identifier des lacunes apparentes, mais l’évaluation de la nouveauté requiert une connaissance fine du domaine, que seule l’expertise humaine peut fournir pour le moment." },
    ...
    'Développement de protocoles expérimentaux ou de recherche': { title: "Vigilance", content: "L'IAg peut générer des protocoles standards. Assurez-vous de les adapter précisément à votre contexte et de détailler chaque étape pour garantir la reproductibilité." },
    'Sélection des méthodes de recherche': { title: "Vigilance", content: "L'IAg peut suggérer des méthodes populaires, mais pas toujours les plus pertinentes. Justifiez votre choix en fonction de votre cadre théorique et de vos objectifs." },
    ...
    'Création d\'algorithmes pour l\'analyse de données': { title: "Vigilance", content: "La conception d'un algorithme pertinent requiert une expertise profonde. Utilisez l'IAg comme un assistant, mais la logique et la validation de l'algorithme doivent être humaines." },
    'Collecte de données': { title: "Vigilance : Éthique et biais", content: "Si vous utilisez des outils d’IAg pour la collecte (par exemple, web scraping), assurez-vous de respecter les conditions d'utilisation et d'être conscient des biais potentiels dans les données collectées." },
    'Validation (évaluation de la qualité et de la fiabilité des données)': { title: "Vigilance", content: "L'IAg peut identifier des anomalies, mais la décision finale sur la validité d'une donnée repose sur votre jugement et votre connaissance du contexte." },
    'Nettoyage des données': { title: "Bonne pratique", content: "Certains outils d’IAg sont très efficace pour les tâches de nettoyage standard. Conservez une trace de toutes les modifications apportées pour garantir la traçabilité." },
    'Conservation et organisation des données': { title: "Bonne pratique", content: "L'IAg peut aider à structurer et à organiser les données. Assurez-vous que le plan de gestion de données est clair et respecte les normes de votre institution." },
    'Analyse des données': { title: "Vigilance : Biais d'interprétation", content: "L'IAg identifie des corrélations, pas des causalités. L'interprétation des résultats et leur mise en contexte exigent votre expertise scientifique." },
    ...
    'Test de reproductibilité': { title: "Vigilance", content: "L'IAg peut aider à ré-exécuter un code, mais la reproductibilité implique de comprendre et de pouvoir expliquer chaque étape de l'analyse, ce qui reste une tâche humaine pour le moment." },
    'Génération de texte': { title: "Vigilance : Voix d'auteur", content: "Utilisez le texte généré comme une première ébauche. Votre travail consiste à bien analyser sa pertinence et à l’infuser votre voix, votre style et votre argumentation." },
    ...
    'Synthèse de texte': { title: "Vigilance", content: "Le résumé de l'IAg est factuel, pas critique. Il vous appartient d'analyser et de synthétiser les idées principales dans le contexte de votre propre recherche." },
    'Formulation des conclusions': { title: "Vigilance", content: "Les conclusions doivent découler directement de vos résultats et de votre analyse. L'IAg peut aider à les formuler, mais ne peut pas les créer." },
    ...
    'Traduction': { title: "Vigilance : Nuances terminologiques", content: "La traduction réalisé à l’aide d’outils d’IAg est souvent de bonne qualité, mais peut manquer des termes techniques précis de votre domaine. Une révision par une personne experte demeure essentielle." },
    ...
    'Analyse des biais et des discriminations potentielles': { title: "Vigilance", content: "Si vous vous servez d’une IAG pour analyser de biais, il faut considérer que l’outil lui-même peut être biaisé. Considérez-le comme un outil de détection préliminaire, mais assurez-vous de mener une analyse éthique approfondie vous-même." },
    'Analyse des risques éthiques': { title: "Vigilance", content: "L'IAg peut lister des risques standards, mais ne peut pas évaluer la complexité d'une situation éthique particulière. Consultez toujours les comités d'éthique compétents." },
    'Suivi de la conformité aux normes éthiques': { title: "Vigilance", content: "L'IAg peut vérifier la présence de certains éléments (par exemple, consentement), mais ne peut pas juger de la validité réelle de la conformité éthique." },
    ...
    'Évaluation de la qualité': { title: "Vigilance", content: "L'IAg peut évaluer la structure ou la clarté, mais pas la validité scientifique ou la pertinence d'un argument. Cette évaluation critique est au cœur du travail de recherche." },
    ...
    'Recommandations': { title: "Vigilance", content: "Les recommandations générées par des outils d’IAg sont basées sur des modèles statistiques. Elles doivent être évaluées de manière critique à la lumière de votre expertise et des objectifs de votre recherche." },
