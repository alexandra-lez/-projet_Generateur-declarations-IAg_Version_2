...
const contextualTips = {
    ...
    'Création d algorithmes pour analyse de données': { title: "Point de vigilance", content: "La conception d'un algorithme pertinent requiert une expertise profonde. Utilisez l'IAg comme un assistant, mais la logique et la validation de l'algorithme doivent être humaines." },
