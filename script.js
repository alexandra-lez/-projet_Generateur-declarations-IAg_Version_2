...
const contextualTips = {
    ...
    'Sélection des méthodes de recherche': { title: "Bonne pratique", content: "Information à venir." },
    'Génération de code': { title: "Bonne pratique", content: "Information à venir." },
    'Optimisation du code': { title: "Bonne pratique", content: "Information à venir." },
    'Automatisation des processus': { title: "Bonne pratique", content: "Information à venir." },
    'Création algorithmes pour analyse de données': { title: "Bonne pratique", content: "Information à venir." },
