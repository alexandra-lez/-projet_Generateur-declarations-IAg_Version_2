...
const contextualTips = {
    ...
    'Rédiger des questions pour examens': { title: "Point de vigilance : validité et équité", content: "Assurez-vous que les questions générées évaluent le concept ou la compétence appropriés et qu’elles sont exemptes d’imprécisions ou d’erreurs." },
    ...
    'Définition d'objectif de recherche': { title: "Point de vigilance", content: "L'IAg peut aider à clarifier un objectif, mais celui-ci doit découler de votre compréhension profonde du domaine et d'une lacune réelle dans les connaissances." },
