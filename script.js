...
const contextualTips = {
    ...
    'Rédiger des questions d\'examen': { title: "Point de vigilance : validité et équité", content: "Assurez-vous que les questions générées évaluent le concept ou la compétence appropriés et qu’elles sont exemptes d’imprécisions ou d’erreurs." },
    ...
    'Rédiger des annonces ou courriels': { title: "Point de vigilance : ton et personnalisation", content: "Ajustez toujours le ton du message pour qu'il corresponde à votre style de communication habituel. Certains outils d’IAg peuvent proposer des formulations trop formelles ou impersonnelles." },
    ...
    'Définition de l\'objectif de recherche': { title: "Point de vigilance", content: "L'IAg peut aider à clarifier un objectif, mais celui-ci doit découler de votre compréhension profonde du domaine et d'une lacune réelle dans les connaissances." },
    ...
    'Rédaction de la revue de littérature': { title: "Point de vigilance : plagiat et synthèse", content: "Le texte généré par un IAg est plutôt une compilation qu’une synthèse critique. Vous devez réécrire, analyser et intégrer les sources pour créer un argumentaire original." },
    ...
    'Création d\'algorithmes pour l\'analyse de données': { title: "Point de vigilance", content: "La conception d'un algorithme pertinent requiert une expertise profonde. Utilisez l'IAg comme un assistant, mais la logique et la validation de l'algorithme doivent être humaines." },
    ...
    'Test de reproductibilité': { title: "Point de vigilance", content: "L'IAg peut aider à ré-exécuter un code, mais la reproductibilité implique de comprendre et de pouvoir expliquer chaque étape de l'analyse, ce qui reste une tâche humaine pour le moment." },
    ...
    'Traduction': { title: "Point de vigilance : nuances terminologiques", content: "La traduction réalisé à l’aide d’outils d’IAg est souvent de bonne qualité, mais peut manquer des termes techniques précis de votre domaine. Une révision par une personne experte demeure essentielle." },
